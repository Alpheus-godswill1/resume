	...
	<div id="fh5co-about" class="animate-box">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="info">
						<li><span class="first-block">Full Name:</span><span class="second-block">Alpheus Godswill Umanah</span></li>
						<li><span class="first-block">Phone:</span><span class="second-block">+2349057555416</span></li>
						<li><span class="first-block">Email:</span><span class="second-block">harryalph@gmail.com</span></li>
						<!-- <li><span class="first-block">Website:</span><span class="second-block"></span></li> -->
						<li><span class="first-block">Address:</span><span class="second-block">Uyo, Akwaibom State Nigeria.</span></li>
					</ul>
				</div>
				<div class="col-md-8">
					<h2>Hello There!</h2>
	...
	<div id="fh5co-work" class="fh5co-bg-dark">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#self_made" class="work" style="background-image: url(images/.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Brading</span>
						</div>
